ActiveAdmin.register_page "Total Items for CENTRAL campus" do

	content :title => proc{ "Item totals for west" } do
		orders = Order.date.cart_status.central
		...
		orders.each do |o|
			...
			columns do
				column do
					...
					panel "FRESH items for CENTRAL campus" do
					...
					panel "Total items needed this Sunday for CENTRAL campus" do
